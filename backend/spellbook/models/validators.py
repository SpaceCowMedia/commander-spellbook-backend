...
from ..regexs import URL_REGEX, FIRST_CAPITAL_LETTER_REGEX, NO_TRAILING_PUNCTUATION_REGEX, MANA_REGEX, DOUBLE_SQUARE_BRACKET_TEXT_REGEX, SYMBOLS_TEXT_REGEX, ORDINARY_CHARACTERS_REGEX
from ..parsers.scryfall_query_parser import SCRYFALL_PARSER, VARIABLES_SUPPORTED
...
SCRYFALL_QUERY_VALIDATOR = LarkGrammarValidator(SCRYFALL_PARSER)
