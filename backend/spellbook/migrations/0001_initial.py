    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('includes', models.ManyToManyField(blank=True, help_text='Cards that this combo includes', related_name='included_in_combos', to='spellbook.card')),
            ],
            options={
                'verbose_name': 'combo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('of', models.ForeignKey(editable=False, help_text='Combo that this variant is an instance of', on_delete=django.db.models.deletion.CASCADE, related_name='variants', to='spellbook.combo')),
        ...
        migrations.AddField(
            model_name='combo',
            name='needs',
            field=models.ManyToManyField(blank=True, help_text='Features that this combo needs', related_name='needed_by_combos', to='spellbook.feature'),
        ),
        migrations.AddField(
            model_name='combo',
            name='produces',
            field=models.ManyToManyField(help_text='Features that this combo produces', related_name='produced_by_combos', to='spellbook.feature'),
        ),
        migrations.AddField(
            model_name='card',
            name='features',
