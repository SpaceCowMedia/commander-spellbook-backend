    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('G', 'Generator'), ('U', 'Utility'), ('M', 'Generator With Many Cards')], default='G', help_text='Is this combo a generator for variants?', max_length=2, verbose_name='kind')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='short description of the template in natural language', max_length=255, validators=[django.core.validators.RegexValidator(message='Must start with a capital letter.', regex='^[A-Z]')], verbose_name='template name')),
