    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mana_needed', models.CharField(blank=True, default='', help_text='Mana needed for this combo. Use the {1}{W}{U}{B}{R}{G}{B/P}... format.', max_length=200, validators=[django.core.validators.RegexValidator(message='Mana needed must be in the {1}{W}{U}{B}{R}{G}{B/P}... format.', regex='^(?:\\{(?:[0-9WUBRGCXS]|1[0-6])(?:\\/[WUBRG])?(?:\\/[WUBRGP])?\\}\\s?)*$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('includes', sortedm2m.fields.SortedManyToManyField(editable=False, help_text='Cards that this variant includes', related_name='included_in_variants', to='spellbook.card')),
