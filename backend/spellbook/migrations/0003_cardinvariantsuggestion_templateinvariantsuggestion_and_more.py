...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('variant_id', models.CharField(editable=False, error_messages={'unique': 'This combination of cards was already suggested.'}, help_text='Unique ID for this variant suggestion', max_length=128, unique=True)),
