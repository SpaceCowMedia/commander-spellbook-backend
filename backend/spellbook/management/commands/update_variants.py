...
class Command(AbstractCommand):
    ...
    def run(self, *args, **options):
        ...
        self.log('Updating variant counts...')
        updated_variant_count = Variant.objects.update(
            variant_count=Coalesce(
                Subquery(
                    Variant
                    .objects
        ...
        self.log(f'Updating variant counts...done, updated {updated_variant_count} variants', self.style.SUCCESS)
