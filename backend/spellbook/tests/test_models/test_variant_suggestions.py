...
class VariantSuggestionTests(SpellbookTestCaseWithSeeding):
    def test_variant_suggestion_fields(self):
        ...
        self.assertEqual(s.mana_needed, '{W}{W}')
        self.assertEqual(s.easy_prerequisites, 'Some easy requisites.')
        self.assertEqual(s.notable_prerequisites, 'Some notable requisites.')
