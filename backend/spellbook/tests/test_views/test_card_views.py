...
class CardViewsTests(SpellbookTestCaseWithSeeding):
    def card_assertions(self, card_result):
        ...
        self.assertEqual(card_result.legalities.standard_brawl, c.legal_standard_brawl)
        self.assertEqual(card_result.legalities.brawl, c.legal_brawl)
        self.assertEqual(card_result.legalities.competitive_brawl, c.legal_competitive_brawl)
        self.assertEqual(card_result.legalities.alchemy, c.legal_alchemy)
