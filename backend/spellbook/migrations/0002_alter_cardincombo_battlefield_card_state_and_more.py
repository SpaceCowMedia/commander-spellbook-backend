# Generated by Django 4.2.1 on 2023-08-03 13:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='combo',
            name='kind',
            field=models.CharField(choices=[('G', 'Generator'), ('U', 'Utility'), ('M', 'Generator With Many Cards'), ('D', 'Draft')], default='G', help_text='Is this combo a generator for variants?', max_length=2, verbose_name='kind'),
        ),
        migrations.AlterField(
            model_name='combo',
        ...
        migrations.AlterField(
            model_name='variant',
            name='status',
            field=models.CharField(choices=[('N', 'New'), ('D', 'Draft'), ('OK', 'Ok'), ('E', 'Example'), ('R', 'Restore'), ('NW', 'Not Working')], default='N', help_text='Variant status for editors', max_length=2),
        ),
    ]
