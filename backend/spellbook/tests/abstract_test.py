...
class AbstractTestCaseWithSeeding(AbstractTestCase):
    ...
    def populate_db(self):
        ...
        c2 = Card.objects.create(name='B B', oracle_id=uuid.UUID('00000000-0000-0000-0000-000000000002'), identity='U', legal_commander=True, spoiler=False, type_line='Sorcery', oracle_text='x2 x3')
        c3 = Card.objects.create(name='C C', oracle_id=uuid.UUID('00000000-0000-0000-0000-000000000003'), identity='B', legal_commander=False, spoiler=False, type_line='Creature', oracle_text='xx4')
        c4 = Card.objects.create(name='D\' D', oracle_id=uuid.UUID('00000000-0000-0000-0000-000000000004'), identity='R', legal_commander=True, spoiler=True, type_line='Battle', oracle_text='x5x')
        c5 = Card.objects.create(name='E É', oracle_id=uuid.UUID('00000000-0000-0000-0000-000000000005'), identity='G', legal_commander=False, spoiler=True, type_line='Planeswalker', oracle_text='')
        c6 = Card.objects.create(name='F F', oracle_id=uuid.UUID('00000000-0000-0000-0000-000000000006'), identity='WU', legal_commander=True, spoiler=False, type_line='Enchantment', oracle_text='x6')
        ...
        b1 = Combo.objects.create(mana_needed='{W}{W}', other_prerequisites='Some requisites.', description='1', status=Combo.Status.GENERATOR)
        b2 = Combo.objects.create(mana_needed='{U}{U}', other_prerequisites='Some requisites.', description='2', status=Combo.Status.GENERATOR)
        b3 = Combo.objects.create(mana_needed='{B}{B}', other_prerequisites='Some requisites.', description='3', status=Combo.Status.UTILITY)
        b4 = Combo.objects.create(mana_needed='{R}{R}', other_prerequisites='Some requisites.', description='4', status=Combo.Status.GENERATOR)
        b5 = Combo.objects.create(mana_needed='{G}{G}', other_prerequisites='Some requisites.', description='5', status=Combo.Status.UTILITY)
        b6 = Combo.objects.create(mana_needed='{W}{U}{B}{R}{G}', other_prerequisites='Some requisites.', description='6', status=Combo.Status.GENERATOR_WITH_MANY_CARDS)
        b7 = Combo.objects.create(mana_needed='{W}{U}{B}{R}{G}', other_prerequisites='Some requisites.', description='7', status=Combo.Status.DRAFT)
