...
class MinimalSetOfMultisets:
    ...
    __slots__ = ('__sets')
    __sets: set[FrozenMultiset]

    __class_getitem__ = classmethod(GenericAlias)

    def __init__(
        self,
        sets: Iterable[FrozenMultiset] | None = None,
        _internal: set[FrozenMultiset] | None = None,
    ):
        '''
    ...
    def subtree(self, under: FrozenMultiset) -> 'MinimalSetOfMultisets':
        '''
    ...
    def add(self, aset: FrozenMultiset):
        ...
        for s in self.__sets:
            if aset.issubset(s):
                supersets.append(s)
        if supersets:
            self.__sets.difference_update(supersets)
        self.__sets.add(aset)

    def extend(self, sets: Iterable[FrozenMultiset]):
        '''
    ...
    def __contains__(self, aset: FrozenMultiset):
