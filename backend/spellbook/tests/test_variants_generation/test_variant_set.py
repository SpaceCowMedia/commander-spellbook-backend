...
class VariantSetTests(TestCase):
    ...
    def test_variant_set_add(self):
        ...
        variant_set = VariantSet(parameters=variant_set_params)
        self.assertEqual(use_hashable_dict(variant_set.variants()), use_hashable_dict([]))
        variant_set = VariantSet(parameters=variant_set_params, entries=[
            VariantSet.ingredients_to_entry(FrozenMultiset({1: 1, 3: 1}), FrozenMultiset()),
        ])
        self.assertEqual(use_hashable_dict(variant_set.variants()), use_hashable_dict([]))
        variant_set = VariantSet(parameters=variant_set_params, entries=[
            VariantSet.ingredients_to_entry(FrozenMultiset({1: 1, 2: 1}), FrozenMultiset({1: 1})),
        ])
        self.assertEqual(use_hashable_dict(variant_set.variants()), use_hashable_dict([]))
        variant_set = VariantSet(parameters=variant_set_params, entries=[
            VariantSet.ingredients_to_entry(FrozenMultiset({1: 1, 2: 2}), FrozenMultiset()),
        ])
        self.assertEqual(use_hashable_dict(variant_set.variants()), use_hashable_dict([]))
        variant_set = VariantSet(parameters=variant_set_params, entries=[
    ...
    def test_and(self):
        ...
        variant_set_2 = VariantSet(entries=[
            *variant_set_2.entries(),
            VariantSet.ingredients_to_entry(FrozenMultiset({3: 100}), FrozenMultiset({2: 1})),
            VariantSet.ingredients_to_entry(FrozenMultiset({4: 5}), FrozenMultiset({2: 1})),
    ...
    def test_sum(self):
        ...
        variant_set_2 = VariantSet(disallow_multiple_copies, entries=[
            *variant_set_2.entries(),
            VariantSet.ingredients_to_entry(FrozenMultiset({1: 1}), FrozenMultiset({1: 500})),
        ])
        self.assertEqual(use_hashable_dict((variant_set_1 + variant_set_2).variants()), use_hashable_dict([
    ...
    def test_product_sets(self):
        variant_set = VariantSet(entries=[
            VariantSet.ingredients_to_entry(FrozenMultiset({1: 2, 2: 2}), FrozenMultiset()),
            VariantSet.ingredients_to_entry(FrozenMultiset({1: 4}), FrozenMultiset()),
        ])
        ...
        variant_set = VariantSet(entries=[
            ...
            VariantSet.ingredients_to_entry(FrozenMultiset({1: 2}), FrozenMultiset({1: 1})),
            VariantSet.ingredients_to_entry(FrozenMultiset({4: 1}), FrozenMultiset()),
            VariantSet.ingredients_to_entry(FrozenMultiset({5: 1}), FrozenMultiset({1: 5})),
            VariantSet.ingredients_to_entry(FrozenMultiset(), FrozenMultiset({2: 2})),
        ])
        disallow_multiple_copies = VariantSetParameters(allow_multiple_copies=False)
    ...
    def test_filter(self):
        ...
        variant_set = VariantSet(entries=[
            *variant_set.entries(),
            VariantSet.ingredients_to_entry(FrozenMultiset({1: 1}), FrozenMultiset({1: 2})),
        ])
        variant_set = VariantSet(entries=[
            *variant_set.entries(),
            VariantSet.ingredients_to_entry(FrozenMultiset({1: 1000}), FrozenMultiset()),
        ])
